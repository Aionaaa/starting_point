...
#   result = total_money(@people, [:monies])
#   expected = 143
#   assert_equal(expected, result)
# end
...
def test_lend_money
  ...
  person1_expected_money = 0
  person2_expected_money = 3
  assert_equal(person1_expected_money, @person1[:monies])
  assert_equal(person2_expected_money, @person2[:monies])
end
